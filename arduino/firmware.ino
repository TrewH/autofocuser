...
{
  if (userPos < cfg.min_limit)
    return cfg.min_limit;
  if (userPos > cfg.max_limit)
...
void handleCommand(const String &line)
{
  ...
  {
    // MOVE <user_steps> (relative, in user coords)
    char *endp = nullptr;
